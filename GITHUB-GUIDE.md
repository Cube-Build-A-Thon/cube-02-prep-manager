...
This repo is shared by everyone working on **02 · Prep Manager**. About a hundred people work in it at once. That only works if everyone follows the same four rules:
...
```sh
git clone git@github.com:Cube-Build-A-Thon/cube-02-prep-manager.git
cd cube-02-prep-manager
```

HTTPS works too: `git clone https://github.com/Cube-Build-A-Thon/cube-02-prep-manager.git`
...
1. Go to `https://github.com/Cube-Build-A-Thon/cube-02-prep-manager`
